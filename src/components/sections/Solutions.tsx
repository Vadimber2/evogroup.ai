        ...
        >
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <StaggeredContainer className="grid md:grid-cols-3 gap-8" staggerDelay={200}>
                    {/* Banking Card */}
                    <div className="h-full bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/10 transition-all duration-500 hover:transform hover:scale-105 border border-white/10 group flex flex-col">
